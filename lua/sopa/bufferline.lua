...
M.groups = {
  ...
  fill = M.hi_val{bg = 1},
  hint = M.hi_val{at = 'bold,italic', bg = 2, fg = 9},
  hint_diagnostic = M.hi_val{at = 'bold,italic', bg = 2, fg = 9},
  hint_diagnostic_selected = M.hi_val{at = 'bold,italic', bg = 0, fg = 9},
  hint_diagnostic_visible = M.hi_val{at = 'bold,italic', bg = 0, fg = 9},
  hint_selected = M.hi_val{at = 'bold,italic', bg = 0, fg = 9},
  hint_visible = M.hi_val{at = 'bold,italic', bg = 0, fg = 9},
